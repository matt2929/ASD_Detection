...
public class SaveCSV {
    ...
    public void saveData(int numFaces, int smileValue, int leftEyeBlink, int rightEyeBlink, int faceRollValue,
                         int faceYawValue, int facePitchValue, int horizontalGazeAngle, int verticalGazeAngle, double smoothx, double smoothy,double x,double y,double fftX,double fftY) {
        ...
        try {
            ...
            string += load();
            String value = "";
            string += hour + ":" + minute + ":" + second + "," + numFaces + "," + smileValue + "," + leftEyeBlink + "," + rightEyeBlink + "," + faceRollValue + "," + faceYawValue + "," + facePitchValue + "," + horizontalGazeAngle  + "," + x + "," + y  + ","+ smoothx + ","+ smoothy + ","+ fftX + ","+fftY +";";
